...
<body>
  <div class='container'>
    <div class='uicontent'>
      ...
      <div class='row'>
        ...
        <div class='col-8'>
          ...
          <div class='onoff-button' style='font-family:Rubik;weight:bold' align='center'>
            <button class='btn btn-success' type='submit' id='onoff' style='width:200px'>Turn Display Off</button>
          </div>
          &nbsp;
          <div class='bslider'>
          ...
          <hr>
          <div class='reset-button' style='font-family:Rubik;weight:bold' align='center'>
            <button type='submit' class='btn btn-danger' id='reset' style=' width:200px'>Reset Matrix Clock</button>
          </div>
        </div>
        <div class='col-2'>&nbsp;</div>
      </div>
      <div class='row'>
        <div class='col'>
          <p class='text-center'>&nbsp;<br><small>Matrix Clock copyright &copy; 2014-18 Tony Smith</small><br>
